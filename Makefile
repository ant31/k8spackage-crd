...
dockerfile: clean
	docker build -t quay.io/ant31/k8spackage:v$(VERSION) .

dockerfile-canary: clean
	docker build -t quay.io/ant31/k8spackage:canary .
	docker push quay.io/ant31/k8spackage

dockerfile-push: dockerfile
	docker push quay.io/ant31/k8spackage:v$(VERSION)
